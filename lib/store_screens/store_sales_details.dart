...
class Store_Sales_Details extends StatefulWidget {
  //const Store_Sales_Details({Key? key}) : super(key: key);
  final String orderId;

  const Store_Sales_Details(this.orderId);

  @override
  State<Store_Sales_Details> createState() => _Store_Sales_DetailsState();
}

class _Store_Sales_DetailsState extends State<Store_Sales_Details> {
  @override
