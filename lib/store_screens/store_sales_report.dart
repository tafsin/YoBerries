...
class Store_Sales_Report extends StatefulWidget {
  //const Store_Sales_Report({Key? key}) : super(key: key);
  final String storeId;
  final String storeArea;
  final String storeAddress;
  final String storePhoneNumber;

  const Store_Sales_Report(
      this.storeId, this.storeArea, this.storeAddress, this.storePhoneNumber);

  @override
  State<Store_Sales_Report> createState() => _Store_Sales_ReportState();
}

class _Store_Sales_ReportState extends State<Store_Sales_Report> {
